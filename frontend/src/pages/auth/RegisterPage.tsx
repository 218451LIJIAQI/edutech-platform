...
import { BookOpen, GraduationCap, Mail, Lock, ShieldCheck, Eye, EyeOff, AlertCircle, ArrowRight, Info } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(extractErrorMessage(error, 'Registration failed, please try again'));
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-start justify-center py-12 px-4 relative overflow-x-hidden">
      {/* Animated background */}
      ...
      <div className="max-w-lg w-full relative z-10 animate-fadeInUp">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl font-extrabold text-gray-900 mb-3">Create Your Account</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  aria-pressed={formData.role === UserRole.STUDENT}
                ...
                <button
                  ...
                  aria-pressed={formData.role === UserRole.TEACHER}
                  className={`relative p-4 rounded-xl border-2 transition-all duration-300 text-left group ${
