      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="bg-white/95 backdrop-blur-sm shadow-xl border border-gray-100/60 rounded-2xl p-8 md:p-10">
          ...
          <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-200/80">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium mt-1">
                Last updated: {publicSiteConfig.termsLastUpdatedLabel}
              </p>
            </div>
          </div>
          ...
          <div className="max-w-none">
            ...
            <p className="text-gray-700 leading-relaxed">
              Edutech applies the current platform commission settings to each course sale. Teacher earnings are credited to the wallet after successful payment and can be withdrawn through the payout flow available in this build.
            </p>

            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">6.3 Payment Processing</h3>
            <p className="text-gray-700 leading-relaxed">
              This build currently uses a simulated checkout flow for development and testing. Enrollments are confirmed through the application, but no real payment gateway is connected and no card details are collected in the checkout form.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed">
              These Terms shall be governed by and construed in accordance with {publicSiteConfig.governingLawText}.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">13. Contact Information</h2>
            <p className="text-gray-700 leading-relaxed">
              For questions about these Terms, use the support channels published for this deployment:
            </p>
            {publicSiteConfig.legalEmail || publicSiteConfig.supportPhone || publicSiteConfig.supportAddress ? (
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                {publicSiteConfig.legalEmail && <li><strong>Email:</strong> {publicSiteConfig.legalEmail}</li>}
                {publicSiteConfig.supportAddress && <li><strong>Address:</strong> {publicSiteConfig.supportAddress}</li>}
                {publicSiteConfig.supportPhone && <li><strong>Phone:</strong> {publicSiteConfig.supportPhone}</li>}
              </ul>
            ) : (
              <p className="text-gray-700 leading-relaxed">
                This deployment does not publish dedicated legal contact details. Use the Help Center and signed-in support tools provided by the operator.
              </p>
            )}
