        ...
        <div className="card shadow-lg">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul>
              ...
              <li><strong>Learning Progress:</strong> Course enrollment, completion status, quiz results</li>
            </ul>
            ...
            <ul>
              <li><strong>Public Profile:</strong> Your name, avatar, and bio are visible to other users</li>
              <li><strong>Course Reviews:</strong> Your reviews and ratings are publicly visible</li>
              <li><strong>Teacher Information:</strong> Teacher credentials and course content are visible to students</li>
            </ul>
            ...
            <ul>
              ...
              <li><strong>Cloud Hosting:</strong> For storing course content and data</li>
              <li><strong>Email Services:</strong> For sending notifications and updates</li>
              <li><strong>Analytics:</strong> For understanding Platform usage and improvements</li>
            </ul>
            ...
            <ul>
              <li><strong>Email:</strong> privacy@edutech.com</li>
