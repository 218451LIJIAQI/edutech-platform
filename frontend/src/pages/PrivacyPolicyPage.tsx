        ...
        <div className="bg-white/95 backdrop-blur-sm shadow-xl border border-gray-100/60 rounded-2xl p-8 md:p-10">
          ...
          <div className="flex items-center gap-4 mb-8 pb-8 border-b border-gray-200/80">
            ...
            <div>
              ...
              <p className="text-gray-500 font-medium mt-1">
                Last updated: {publicSiteConfig.privacyLastUpdatedLabel}
              </p>
            </div>
          </div>
          ...
          <article className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li><strong className="text-gray-900">Payment Information:</strong> This build uses simulated checkout and does not collect real card numbers, expiry dates, or CVC values</li>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li><strong className="text-gray-900">Payment Processing:</strong> Simulated checkout is enabled for development and testing in this build, without collecting card details</li>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>Authenticated local checkout and protected account/session handling in this development build</li>
            </ul>
            <p className="text-gray-700 leading-relaxed">
            ...
            <p className="text-gray-700 leading-relaxed">
              If you have questions about this Privacy Policy or wish to exercise your rights, use the published support channels for this deployment:
            </p>
            {publicSiteConfig.privacyEmail || publicSiteConfig.supportPhone || publicSiteConfig.supportAddress ? (
              <ul className="list-disc pl-6 space-y-2 text-gray-700">
                {publicSiteConfig.privacyEmail && <li><strong className="text-gray-900">Email:</strong> {publicSiteConfig.privacyEmail}</li>}
                {publicSiteConfig.supportAddress && <li><strong className="text-gray-900">Address:</strong> {publicSiteConfig.supportAddress}</li>}
                {publicSiteConfig.supportPhone && <li><strong className="text-gray-900">Phone:</strong> {publicSiteConfig.supportPhone}</li>}
              </ul>
            ) : (
              <p className="text-gray-700 leading-relaxed">
                This deployment does not publish direct privacy contact details. Use the Help Center and signed-in support tools provided by the operator.
              </p>
            )}
