...
const HelpCenterPage = () => {
  ...
  const publishedSupportEmail = publicSiteConfig.supportEmail;
  const refundSupportText = publishedSupportEmail
    ? `Refund policies vary by course. Please contact ${publishedSupportEmail} with your enrollment details for refund requests.`
    : 'Refund policies vary by course. Submit the request from the order details page or use the support channel configured for this deployment.';
  ...
  const faqs: FAQItem[] = useMemo(() => [
    ...
    },
    {
      ...
      answer: 'Browse courses, select one you like, choose a pricing package, and complete the checkout flow. Access is granted when the enrollment is confirmed for your account.',
    },
    {
      id: 'faq-4',
      category: 'courses',
      question: 'Can I get a refund for a course?',
      answer: refundSupportText,
    },
    {
      id: 'faq-5',
      category: 'courses',
    ...
    },
    {
      ...
      answer: 'This build currently runs a simulated checkout flow for development and testing. It confirms enrollments through the platform backend without collecting or charging real card details.',
    },
    {
      id: 'faq-7',
      category: 'payments',
      question: 'Is my payment information secure?',
      answer: 'Yes. This build does not request or store card numbers, expiry dates, or CVC values. Enrollment confirmation is simulated until a real payment gateway is integrated.',
    },
    {
      id: 'faq-8',
      category: 'teachers',
    ...
    },
    {
      ...
      answer: 'Teacher earnings are calculated using the platform commission settings for each sale. Available balance appears in the wallet page, and payouts can be requested there using your saved payout method.',
    },
    {
      id: 'faq-10',
      category: 'teachers',
    ...
    },
    {
      ...
      answer: 'Click "Forgot Password" on the login page, request a reset code, verify the code, and then set a new password.',
    },
    {
      id: 'faq-13',
      category: 'technical',
            ...
            <div className="bg-gradient-to-br from-primary-500 via-primary-600 to-indigo-600 text-white rounded-2xl p-8 sticky top-20 shadow-xl shadow-primary-500/20 relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-white/80 mb-8 leading-relaxed">
                  Can't find what you're looking for? Published support channels vary by deployment.
                </p>
              ...
              <div className="space-y-4">
                {publicSiteConfig.supportEmail && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-primary-100">{publicSiteConfig.supportEmail}</p>
                    </div>
                  </a>
                )}

                {publicSiteConfig.supportPhone && (
                  <a
                    href={`tel:${publicSiteConfig.supportPhone.replace(/[^+\d]/g, '')}`}
                    className="flex items-center gap-4 p-5 bg-white/20 rounded-xl hover:bg-white/30 transition-all border border-white/30 backdrop-blur-sm hover:shadow-lg transform hover:scale-105"
                  >
                    <div className="p-3 bg-white/30 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-primary-100">{publicSiteConfig.supportPhone}</p>
                    </div>
                  </a>
                )}
                ...
                <div className="flex items-center gap-4 p-5 bg-white/20 rounded-xl border border-white/30 backdrop-blur-sm">
                  ...
                  <div>
                    <p className="font-bold text-white text-lg">Signed-in Support</p>
                    <p className="text-sm text-primary-100">
                      {publicSiteConfig.supportHours || 'Use the in-app support center after signing in to open or track a ticket.'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 p-5 bg-white/20 rounded-xl border border-white/30 backdrop-blur-sm">
                <p className="text-sm text-white/80">
                  <strong className="text-white">Response Time:</strong> {publicSiteConfig.supportResponseWindow || 'Response times depend on operator coverage and queue volume.'}
                </p>
              </div>
              </div>
            </div>
