...
import { BookOpen, Users, Award, TrendingUp, ArrowRight, Target, Rocket, Star, Sparkles } from 'lucide-react';
...
const FEATURES = [
  { icon: Users, title: "Trusted Teachers", desc: "Browse approved teachers and look for verified badges on standout profiles" },
...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center overflow-hidden pb-28 sm:pb-32">
        {/* Gradient Background */}
            ...
            {isRestoringSession ? (
              <>
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
                  ...
                  <span className="text-white/90 text-sm font-medium">Restoring your dashboard</span>
                </div>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-6 leading-[1.1]">
                  Loading your <span className="bg-gradient-to-r from-primary-200 to-indigo-200 bg-clip-text text-transparent">workspace</span>
                </h1>
                <p className="text-xl md:text-2xl mb-10 text-white/80 leading-relaxed max-w-2xl">
                  We are reconnecting your session and loading your latest account details.
                </p>
              </>
            ) : isSessionReady ? (
              <>
              ...
              <>
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
                  <Rocket className="w-5 h-5 text-primary-100" />
                ...
                {/* Stats */}
                <div className="flex flex-wrap gap-8 mt-16 pt-8 border-t border-white/10 relative z-10">
                  <div>
