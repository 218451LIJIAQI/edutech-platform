...
export const TeachersPage = lazy(() => import('./public-teachers/TeachersPage'));
export const TeacherProfilePage = lazy(() => import('./public-teachers/TeacherProfilePage'));
...
// Teacher Pages
// ================================
export const TeacherDashboard = lazy(() => import('./teacher-portal/TeacherDashboard'));
export const TeacherPendingPage = lazy(() => import('./teacher-portal/TeacherPendingPage'));
export const ManageCoursesPage = lazy(() => import('./teacher-portal/ManageCoursesPage'));
export const CreateCoursePage = lazy(() => import('./teacher-portal/CreateCoursePage'));
export const CourseManagementPage = lazy(() => import('./teacher-portal/CourseManagementPage'));
export const VerificationPage = lazy(() => import('./teacher-portal/VerificationPage'));
export const StudentsPage = lazy(() => import('./teacher-portal/StudentsPage'));
export const WalletPage = lazy(() => import('./teacher-portal/WalletPage'));
export const TeacherStudentManagementPage = lazy(() => import('./teacher-portal/TeacherStudentManagementPage'));
export const ProfileCompletionPage = lazy(() => import('./teacher-portal/ProfileCompletionPage'));

// ================================
// Admin Pages
// ================================
export const AdminDashboard = lazy(() => import('./admin/AdminDashboard'));
export const AdsManagement = lazy(() => import('./admin/AdsManagement'));
