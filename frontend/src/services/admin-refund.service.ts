...
import { normalizeRefund, toFiniteNumber } from '@/utils/asset-normalizers';
...
const adminRefundService = {
  ...
  getAllRefunds: async (
    ...
    return {
      ...res.data.data,
      refunds: res.data.data.refunds.map(normalizeRefund),
    };
  },
  ...
  approveRefund: async (id: string, adminNotes?: string): Promise<Refund> => {
    ...
    return normalizeRefund(res.data.data);
  },
  ...
  getStats: async (): Promise<{
    ...
    return {
      ...res.data.data,
      totalRefundAmount: toFiniteNumber(res.data.data.totalRefundAmount),
      completedRefundAmount: toFiniteNumber(res.data.data.completedRefundAmount),
    };
  },
};
